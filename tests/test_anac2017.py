"""
Tests for ANAC 2017 negotiating agents using hypothesis for property-based testing.
...
# Get all 2017 agents
ANAC_2017_AGENTS = get_agents(group="anac2017")
...
class TestANAC2017AgentInstantiation:
    """Test that all ANAC 2017 agents can be properly instantiated."""

    @pytest.mark.parametrize("agent_class", ANAC_2017_AGENTS)
...
class TestANAC2017AgentNegotiations:
    """Test basic negotiation functionality of ANAC 2017 agents."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Mosa, ParsAgent3),
            (ParsAgent3, Rubick),
            (Rubick, SimpleAgent2017),
            (SimpleAgent2017, TaxiBox),
            (TaxiBox, PonPokoAgent),
        ],
    )
    def test_cross_agent_negotiation(
        self, buyer_class, seller_class, simple_issues, buyer_ufun, seller_ufun
    ):
        """Test negotiations between different 2017 agents."""
        mechanism = SAOMechanism(issues=simple_issues, n_steps=100)
...
class TestANAC2017HypothesisBased:
...
class TestANAC2017EdgeCases:
    """Test edge cases for ANAC 2017 agents."""
