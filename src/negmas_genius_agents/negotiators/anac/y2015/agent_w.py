...
This module implements AgentW, a negotiation agent that competed in the
Sixth International Automated Negotiating Agents Competition (ANAC 2015).
AgentW uses a patient "waiting" strategy that observes opponent behavior
before committing to a concession pattern.
